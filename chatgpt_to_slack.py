...
if __name__ == "__main__":
    ...
    # 質問を設定
    question = f"あなたはプロの作家兼経営者です。以下の入力文はあなたの会社が培ってきたマインドの１つです。制約条件を元に文章を出力してください。\n\n制約条件:\n###\n入力文(マインド)に関連した文章を500文字以内で作成してください。\n但し社員にそのマインドの浸透が促進されるような魅力的な文章にしてください。\n次に続く単語は使わないこと:'社訓','社員','買収','本社'\n###\n\n入力文:\n###\n{selected_item}\n###"
